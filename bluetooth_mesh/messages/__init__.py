from construct import Construct, Container, SizeofError, stream_read_entire, stream_write
...
class _AccessMessage(Construct):
    ...
    def _parse(self, stream, context, path):
        ...
        try:
            ...
            return Container(opcode=opcode, params=stream_read_entire(stream, path))
    ...
    def _build(self, obj, stream, context, path):
        ...
        try:
            ...
            params = obj["params"]
            stream_write(stream, params, len(params), path)
            return obj
