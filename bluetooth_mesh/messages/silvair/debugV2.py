...
class DebugV2ParameterTypes(IntEnum):
    ...
    CPU_USAGE_CURRENT_STATS = 0x22
    CPU_USAGE_HISTOGRAM = 0x23
    CPU_USAGE_HISTORY = 0x24
    CPU_USAGE_HISTORY_SETUP = 0x25
    LAST_MEASURED_POWER_OFF_TIME_MS = 0x27
    LAST_MEASURED_DALI_BUS_SHORT_TO_POWER_OFF_TIME_MS = 0x28
    LAST_RESET_FIRST_FAULT_INFO = 0x29
    LC_OLC_AMBIENT_LUX_LEVEL = 0x2A
    APP_THREAD_STARTUP_LATENCY = 0x2B
    APP_THREAD_RUNTIME_LATENCY = 0x2C
    APP_THREAD_RUNTIME_EXCLUDING_FLASH_OPERATIONS_LATENCY = 0x2D
    DALI_CONNECTED_DRIVERS = 0x2E
    SCG_PLATFORM_ENVIRONMENT = 0x2F
