...
valid = [
    ...
    pytest.param(
        ...
        {
            "property_id": EmergencyLightingProperty.EL_LIGHTNESS,
            "el_lightness": {"perceived_lightness": 0x1234},
        },
    ),
    pytest.param(
        ...
        {
            "property_id": EmergencyLightingProperty.EL_LIGHTNESS_RANGE_MIN,
            "el_lightness_range_min": {"perceived_lightness": 0x1234},
        },
    ),
    pytest.param(
        ...
        {
            "property_id": EmergencyLightingProperty.EL_LIGHTNESS_RANGE_MAX,
            "el_lightness_range_max": {"perceived_lightness": 0x1234},
        },
    ),
    pytest.param(
        ...
        {
            "property_id": EmergencyLightingProperty.EL_PROLONG_TIME,
            "el_prolong_time": {"seconds": 0x1234},
        },
    ),
    pytest.param(
...
def test_build(encoded, subopcode, payload):
    assert EmergencyLightingParams.build({"subopcode": subopcode, "payload": payload}) == encoded
