...
valid = [
    pytest.param(
        b"\x02\x09\x00\x02\x00\x10\x20\x30",
        DebugV2SubOpcode.STATUS,
        DebugV2ParameterTypes.UPTIME,
        0x00,
        [
    ...
    pytest.param(
        b"\x02\x08\x00\x04\x20",
        DebugV2SubOpcode.STATUS,
        DebugV2ParameterTypes.RSSI_THRESHOLD,
        0x00,
        [
            {"data_type": DebugV2DataTypes.INT8, "parameter": 0x20},
        ],
        id="StatusRSSIThreshold",
    ),
    pytest.param(
        b"\x02\x0b\x02\x0c\x06\x00\x10\x00\x20\x00\x30",
        DebugV2SubOpcode.STATUS,
        DebugV2ParameterTypes.TIME_SYNC_MSG_LIST,
        0x02,
        [
    ...
    pytest.param(
        b"\x02\x4b\x00\x0b\x09my string",
        DebugV2SubOpcode.STATUS,
        0x4B,
        0x00,
        [
            {"data_type": DebugV2DataTypes.STRING, "parameter": "my string"},
        ],
        id="StatusUnknownParameterString",
    ),
    pytest.param(
        b"\x02\x55\x00\x02\x00\x10\x20\x30\x0a\x00\x08\x00\x32\x00\x28",
        DebugV2SubOpcode.STATUS,
        0x55,
        0x00,
        [
    ...
    pytest.param(
        b"\x03\x13\x00",
        DebugV2SubOpcode.CLEAR,
        DebugV2ParameterTypes.OCCUPANCY_HISTORY,
        0x00,
        [],
    ...
    pytest.param(
        b"\x00\x0f\x00",
        DebugV2SubOpcode.GET,
        DebugV2ParameterTypes.RECALLED_EVENTS_TIME,
        0x00,
        [],
...
@pytest.mark.parametrize("encoded, subopcode, parameter_type, page_number, payload", valid)
