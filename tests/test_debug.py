...
valid = [
    ...
    pytest.param(
        ...
        {},
        id="ProvisionedAppVersionGet",
    ),
    pytest.param(
        b"\x1b",
        DebugSubOpcode.FULL_FIRMWARE_VERSION_GET,
        {},
        id="FullFirmwareVersionGet",
    ),
    pytest.param(
        b"\x1d",
    ...
    pytest.param(
        ...
        {},
        id="LastMallocFaultClear",
    ),
    pytest.param(
        b"\x15",
        DebugSubOpcode.LAST_FDS_FAULT_CLEAR,
        {},
        id="FastFdsFaultClear",
    ),
    pytest.param(
        b"\x21",
    ...
    pytest.param(
        ...
        {
            "stats": [
                {"name": "KERNEL", "high_water_mark": 520},
                {"name": "BLE", "high_water_mark": 1288},
                {"name": "SNV", "high_water_mark": 200},
                {"name": "APP", "high_water_mark": 436},
                {"name": "RX Task", "high_water_mark": 484},
                {"name": "MESH", "high_water_mark": 1032},
                {"name": "Tmr Svc", "high_water_mark": 496},
                {"name": "IDLE", "high_water_mark": 228},
                {"name": "HEAP", "high_water_mark": 18856},
            ]
        },
    ...
    pytest.param(
        ...
        {
            "stats": [
                {"name": "HEAP", "high_water_mark": 19080},
                {"name": "Tmr Svc", "high_water_mark": 552},
                {"name": "IDLE", "high_water_mark": 244},
            ]
        },
    ...
    pytest.param(
        ...
        {
            "stats": [
                {"name": "HEAP", "high_water_mark": 100023},
                {"name": "Tmr Svc", "high_water_mark": 552},
                {"name": "IDLE", "high_water_mark": 244},
            ]
        },
...
def test_build_valid(encoded, subopcode, payload):
    assert DebugParams.build({"subopcode": subopcode, "payload": payload}) == encoded
