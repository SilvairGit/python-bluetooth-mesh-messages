...
valid_setup = [
    ...
    pytest.param(
        ...
        dict(
            ...
            sensor_setting_access=SensorSettingAccess.READ_ONLY,
            average_input_current=dict(electric_current_value=2.0, sensing_duration=dict(seconds=0.5132)),
        ),
        id="SENSOR_SETTING_STATUS",
    ),
]
...
valid_properties = [
    ...
    pytest.param(
        ...
        dict(
            ...
            average_output_voltage=dict(voltage_value=12.5, sensing_duration=dict(seconds=6.7275)),
        ),
        id="AverageVoltage",
    ),
    pytest.param(
        ...
        dict(
            sensor_property_id=PropertyID.PRESENT_INPUT_CURRENT,
            sensor_setting_property_id=PropertyID.AVERAGE_INPUT_CURRENT,
            average_input_current=dict(electric_current_value=2.0, sensing_duration=dict(seconds=0)),
        ),
    ...
    pytest.param(
        ...
        dict(
            ...
            sensor_setting_property_id=PropertyID.PRESENT_INPUT_VOLTAGE,
            present_input_voltage=dict(voltage=12),
        ),
        id="Voltage",
    ),
    pytest.param(
        ...
        dict(
            ...
            presence_detected=dict(presence_detected=True),
        ),
        id="Presence",
    ),
    pytest.param(
        ...
        dict(
            ...
            motion_sensed=dict(percentage=40),
        ),
        id="Percentage8",
    ),
    pytest.param(
        ...
        dict(
            ...
            light_control_time_fade=dict(seconds=3),
        ),
    ...
    pytest.param(
        ...
        dict(
            ...
            total_device_power_on_time=dict(hours=10),
        ),
        id="TimeHour24",
    ),
    pytest.param(
        ...
        dict(
            sensor_property_id=PropertyID.TOTAL_DEVICE_POWER_ON_TIME,
            sensor_setting_property_id=PropertyID.TOTAL_DEVICE_POWER_ON_TIME,
            total_device_power_on_time=dict(hours=float(sys.float_info.max)),
        ),
    ...
    pytest.param(
        ...
        dict(
            ...
            present_illuminance=dict(illuminance=100.1),
        ),
        id="Illuminance",
    ),
    pytest.param(
        ...
        dict(
            ...
            people_count=dict(count=0x1A1B),
        ),
        id="Count16",
    ),
    pytest.param(
        ...
        dict(
            ...
            total_device_power_on_cycles=dict(count=0x1A1BFF),
        ),
        id="Count24",
    ),
    pytest.param(
        ...
        dict(
            sensor_property_id=PropertyID.TOTAL_DEVICE_POWER_ON_CYCLES,
            sensor_setting_property_id=PropertyID.TOTAL_DEVICE_POWER_ON_CYCLES,
            total_device_power_on_cycles=dict(count=float(sys.float_info.max)),
        ),
        id="Count24_unknown",
    ),
    pytest.param(
        ...
        dict(
            ...
            time_since_motion_sensed=dict(seconds=5),
        ),
        id="TimeSecond16",
    ),
    pytest.param(
    ...
    pytest.param(
        ...
        dict(
            ...
            precise_total_device_energy_use=dict(energy=1672925),
        ),
        id="PreciseEnergy",
    ),
    pytest.param(
        ...
        dict(
            sensor_property_id=PropertyID.PRECISE_TOTAL_DEVICE_ENERGY_USE,
            sensor_setting_property_id=PropertyID.PRECISE_TOTAL_DEVICE_ENERGY_USE,
            precise_total_device_energy_use=dict(energy=4294967.295),
        ),
    ...
    pytest.param(
        ...
        dict(
            ...
            active_energy_load_side=dict(energy=1672925),
        ),
        id="Energy32",
    ),
    pytest.param(
        ...
        dict(
            sensor_property_id=PropertyID.ACTIVE_ENERGY_LOAD_SIDE,
            sensor_setting_property_id=PropertyID.ACTIVE_ENERGY_LOAD_SIDE,
            active_energy_load_side=dict(energy=4294967.295),
        ),
    ...
    pytest.param(
        ...
        dict(
            ...
            apparent_energy=dict(energy=1672925),
        ),
        id="ApparentEnergy32",
    ),
    pytest.param(
        ...
        dict(
            sensor_property_id=PropertyID.APPARENT_ENERGY,
            sensor_setting_property_id=PropertyID.APPARENT_ENERGY,
            apparent_energy=dict(energy=4294967.295),
        ),
    ...
    pytest.param(
        ...
        dict(
            ...
            light_control_lightness_on=dict(perceived_lightness=0xFF44),
        ),
    ...
    pytest.param(
        ...
        dict(
            ...
            light_control_regulator_kid=dict(coefficient=0x0000FF44),
        ),
        id="Coefficient",
    ),
    pytest.param(
        ...
        dict(
            ...
            present_device_input_power=dict(power=10000),
        ),
        id="Power",
    ),
    pytest.param(
        ...
        dict(
            sensor_property_id=PropertyID.PRESENT_DEVICE_INPUT_POWER,
            sensor_setting_property_id=PropertyID.PRESENT_DEVICE_INPUT_POWER,
            present_device_input_power=dict(power=1677721.5),
        ),
