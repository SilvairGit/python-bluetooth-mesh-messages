...
valid_properties = [
    ...
    pytest.param(
        ...
        dict(
            ...
            device_global_trade_item_number=dict(global_trade_item_number=0xAABBCCDDEEFF),
        ),
    ...
    pytest.param(
        ...
        dict(
            ...
            device_appearance=dict(category=960, sub_category=4),
        ),
        id="Appearance",
    ),
    pytest.param(
    ...
    pytest.param(
        ...
        dict(
            ...
            relative_runtime_in_an_input_voltage_range=dict(
                relative_value=0x44, minimum_voltage=12.5, maximum_voltage=12.5
            ),
        ),
