...
valid = [
    ...
    pytest.param(
        ...
        SensorOpcode.SENSOR_DESCRIPTOR_GET,
        {
            "property_id": PropertyID.AVERAGE_OUTPUT_CURRENT,
        },
    ...
    pytest.param(
        ...
        SensorOpcode.SENSOR_GET,
        {
            "property_id": PropertyID.CHROMATICITY_TOLERANCE,
        },
    ...
    pytest.param(
        ...
        [
            {
                "sensor_property_id": PropertyID.DEVICE_DATE_OF_MANUFACTURE,
    ...
    pytest.param(
        ...
        [
            {
                "sensor_property_id": PropertyID.DEVICE_SERIAL_NUMBER,
            }
        ],
    ...
    pytest.param(
        ...
        [
            ...
            {
                "sensor_property_id": PropertyID.INITIAL_LUMINOUS_FLUX,
        ...
        [
            {
                ...
                "length": 2,
                "format": 0,
                "present_input_current": {"current": 2.0},
            }
        ],
        ...
        [
            {
                ...
                "length": 2,
                "format": 0,
                "present_input_voltage": {"voltage": 12.5},
            }
        ],
        ...
        [
            {
                ...
                "length": 3,
                "format": 0,
                "total_device_energy_use": {"energy": 0xFF44A2},
            }
        ],
    ...
    pytest.param(
        ...
        [
            {
                "sensor_setting_property_id": 0x4090,
                "length": 5,
                "format": 1,
...
valid_setup = [
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.LIGHT_CONTROL_LIGHTNESS_STANDBY,
            "sensor_setting_property_ids": [
                PropertyID.AVERAGE_AMBIENT_TEMPERATURE_IN_A_PERIOD_OF_DAY,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.PRESENT_INPUT_CURRENT,
            "sensor_setting_property_id": PropertyID.PRESENT_INPUT_CURRENT,
            "present_input_current": {"current": 2.0},
        },
    ...
    pytest.param(
        ...
        SensorSetupOpcode.SENSOR_SETTING_STATUS,
        {
            ...
            "sensor_setting_access": SensorSettingAccess.READ_ONLY,
            "average_input_current": {"electric_current_value": 2.0, "sensing_duration": {"seconds": 0.5132}},
        },
        id="SENSOR_SETTING_STATUS",
    ),
]
...
valid_properties = [
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.AVERAGE_OUTPUT_VOLTAGE,
            "sensor_setting_property_id": PropertyID.AVERAGE_OUTPUT_VOLTAGE,
            "average_output_voltage": {"voltage_value": 12.5, "sensing_duration": {"seconds": 6.7275}},
        },
        id="AverageVoltage",
    ),
    pytest.param(
        b"\x59\x57\x00\x02\x00\xc8\x00\x00",
        {
            "sensor_property_id": PropertyID.PRESENT_INPUT_CURRENT,
            "sensor_setting_property_id": PropertyID.AVERAGE_INPUT_CURRENT,
            "average_input_current": {"electric_current_value": 2.0, "sensing_duration": {"seconds": 0}},
        },
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.PRESENT_INPUT_VOLTAGE,
            "sensor_setting_property_id": PropertyID.PRESENT_INPUT_VOLTAGE,
            "present_input_voltage": {"voltage": 12},
        },
        id="Voltage",
    ),
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.MOTION_SENSED,
            "sensor_setting_property_id": PropertyID.PRESENCE_DETECTED,
            "presence_detected": {"presence_detected": True},
        },
        id="Presence",
    ),
    pytest.param(
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.DEVICE_APPEARANCE,
            "sensor_setting_property_id": PropertyID.LIGHT_CONTROL_TIME_FADE,
            "light_control_time_fade": {"seconds": 3},
        },
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.TOTAL_DEVICE_POWER_ON_TIME,
            "sensor_setting_property_id": PropertyID.TOTAL_DEVICE_POWER_ON_TIME,
            "total_device_power_on_time": {"hours": 10},
        },
        id="TimeHour24",
    ),
    pytest.param(
        b"\x59\x6d\x00\x6d\x00\xff\xff\xff",
        {
            "sensor_property_id": PropertyID.TOTAL_DEVICE_POWER_ON_TIME,
            "sensor_setting_property_id": PropertyID.TOTAL_DEVICE_POWER_ON_TIME,
            "total_device_power_on_time": {"hours": float(sys.float_info.max)},
        },
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.PRESENT_ILLUMINANCE,
            "sensor_setting_property_id": PropertyID.PRESENT_ILLUMINANCE,
            "present_illuminance": {"illuminance": 100.1},
        },
        id="Illuminance",
    ),
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.PEOPLE_COUNT,
            "sensor_setting_property_id": PropertyID.PEOPLE_COUNT,
            "people_count": {"count": 0x1A1B},
        },
        id="Count16",
    ),
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.TOTAL_DEVICE_POWER_ON_CYCLES,
            "sensor_setting_property_id": PropertyID.TOTAL_DEVICE_POWER_ON_CYCLES,
            "total_device_power_on_cycles": {"count": 0x1A1BFF},
        },
        id="Count24",
    ),
    pytest.param(
        b"\x59\x6c\x00\x6c\x00\xff\xff\xff",
        {
            "sensor_property_id": PropertyID.TOTAL_DEVICE_POWER_ON_CYCLES,
            "sensor_setting_property_id": PropertyID.TOTAL_DEVICE_POWER_ON_CYCLES,
            "total_device_power_on_cycles": {"count": float(sys.float_info.max)},
        },
        id="Count24_unknown",
    ),
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.TIME_SINCE_MOTION_SENSED,
            "sensor_setting_property_id": PropertyID.TIME_SINCE_MOTION_SENSED,
            "time_since_motion_sensed": {"seconds": 5},
        },
        id="TimeSecond16",
    ),
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.SHORT_CIRCUIT_EVENT_STATISTICS,
            "sensor_setting_property_id": PropertyID.SHORT_CIRCUIT_EVENT_STATISTICS,
            "short_circuit_event_statistics": {
                "number_of_events": {"count": 5},
                "average_event_duration": {"seconds": 1},
                "time_elapsed_since_last_event": {"seconds": 97.0172},
                "sensing_duration": {"seconds": 1},
            },
        },
        id="EventStatistics",
    ),
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.DEVICE_FIRMWARE_REVISION,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.DEVICE_MANUFACTURER_NAME,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.TOTAL_DEVICE_ENERGY_USE,
            "sensor_setting_property_id": PropertyID.TOTAL_DEVICE_ENERGY_USE,
            "total_device_energy_use": {"energy": 0xFF44A2},
        },
        id="Energy",
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.PRECISE_TOTAL_DEVICE_ENERGY_USE,
            "sensor_setting_property_id": PropertyID.PRECISE_TOTAL_DEVICE_ENERGY_USE,
            "precise_total_device_energy_use": {"energy": 1672925},
        },
        id="PreciseEnergy",
    ),
    pytest.param(
        b"Yr\x00r\x00\xff\xff\xff\xff",
        {
            "sensor_property_id": PropertyID.PRECISE_TOTAL_DEVICE_ENERGY_USE,
            "sensor_setting_property_id": PropertyID.PRECISE_TOTAL_DEVICE_ENERGY_USE,
            "precise_total_device_energy_use": {"energy": 4294967.295},
        },
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.ACTIVE_ENERGY_LOAD_SIDE,
            "sensor_setting_property_id": PropertyID.ACTIVE_ENERGY_LOAD_SIDE,
            "active_energy_load_side": {"energy": 1672925},
        },
        id="Energy32",
    ),
    pytest.param(
        b"Y\x80\x00\x80\x00\xff\xff\xff\xff",
        {
            "sensor_property_id": PropertyID.ACTIVE_ENERGY_LOAD_SIDE,
            "sensor_setting_property_id": PropertyID.ACTIVE_ENERGY_LOAD_SIDE,
            "active_energy_load_side": {"energy": 4294967.295},
        },
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.APPARENT_ENERGY,
            "sensor_setting_property_id": PropertyID.APPARENT_ENERGY,
            "apparent_energy": {"energy": 1672925},
        },
        id="ApparentEnergy32",
    ),
    pytest.param(
        b"Y\x83\x00\x83\x00\xff\xff\xff\xff",
        {
            "sensor_property_id": PropertyID.APPARENT_ENERGY,
            "sensor_setting_property_id": PropertyID.APPARENT_ENERGY,
            "apparent_energy": {"energy": 4294967.295},
        },
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.LIGHT_CONTROL_LIGHTNESS_ON,
            "sensor_setting_property_id": PropertyID.LIGHT_CONTROL_LIGHTNESS_ON,
            "light_control_lightness_on": {"perceived_lightness": 0xFF44},
        },
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.LIGHT_CONTROL_REGULATOR_KID,
            "sensor_setting_property_id": PropertyID.LIGHT_CONTROL_REGULATOR_KID,
            "light_control_regulator_kid": {"coefficient": 0x0000FF44},
        },
        id="Coefficient",
    ),
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.PRESENT_DEVICE_INPUT_POWER,
            "sensor_setting_property_id": PropertyID.PRESENT_DEVICE_INPUT_POWER,
            "present_device_input_power": {"power": 10000},
        },
        id="Power",
    ),
    pytest.param(
        b"\x59\x52\x00\x52\x00\xff\xff\xff",
        {
            "sensor_property_id": PropertyID.PRESENT_DEVICE_INPUT_POWER,
            "sensor_setting_property_id": PropertyID.PRESENT_DEVICE_INPUT_POWER,
            "present_device_input_power": {"power": 1677721.5},
        },
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.DEVICE_POWER_RANGE_SPECIFICATION,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.PRESENT_AMBIENT_TEMPERATURE,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.PRESENT_DEVICE_OPERATING_TEMPERATURE,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.OUTDOOR_STATISTICAL_VALUES,
            ...
            "outdoor_statistical_values": {
                ...
                "sensing_duration": {"seconds": 106.719},
            },
        },
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.DEVICE_OPERATING_TEMPERATURE_STATISTICAL_VALUES,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.DEVICE_OPERATING_TEMPERATURE_RANGE_SPECIFICATION,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.AVERAGE_AMBIENT_TEMPERATURE_IN_A_PERIOD_OF_DAY,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.RELATIVE_DEVICE_ENERGY_USE_IN_A_PERIOD_OF_DAY,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.INPUT_VOLTAGE_STATISTICS,
            ...
            "input_voltage_statistics": {
                ...
                "sensing_duration": {"seconds": 6.7275},
            },
        },
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.OUTPUT_VOLTAGE_RANGE,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.OUTPUT_CURRENT_STATISTICS,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.OUTPUT_CURRENT_RANGE,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.INPUT_CURRENT_RANGE_SPECIFICATION,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.TOTAL_LUMINOUS_ENERGY,
            "sensor_setting_property_id": PropertyID.TOTAL_LUMINOUS_ENERGY,
            "total_luminous_energy": {
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.CENTER_BEAM_INTENSITY_AT_FULL_POWER,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.LUMINOUS_EXPOSURE,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.LUMINOUS_FLUX_RANGE,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.LUMINOUS_EFFICACY,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.DEVICE_GLOBAL_TRADE_ITEM_NUMBER,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.CHROMATICITY_TOLERANCE,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.PRESENT_PLANCKIAN_DISTANCE,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.PRESENT_CORRELATED_COLOR_TEMPERATURE,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.DEVICE_COUNTRY_OF_ORIGIN,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.PRESENT_CIE1931_CHROMATICITY_COORDINATES,
            "sensor_setting_property_id": PropertyID.PRESENT_CIE1931_CHROMATICITY_COORDINATES,
            "present_cie1931_chromaticity_coordinates": {
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.COLOR_RENDERING_INDEX_R9,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.RELATIVE_DEVICE_RUNTIME_IN_A_GENERIC_LEVEL_RANGE,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.RELATIVE_EXPOSURE_TIME_IN_AN_ILLUMINANCE_RANGE,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.RELATIVE_RUNTIME_IN_A_DEVICE_OPERATING_TEMPERATURE_RANGE,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.RELATIVE_RUNTIME_IN_AN_INPUT_CURRENT_RANGE,
    ...
    pytest.param(
        ...
        {
            "sensor_property_id": PropertyID.RELATIVE_RUNTIME_IN_AN_INPUT_VOLTAGE_RANGE,
...
def test_build_valid(encoded, opcode, data):
    assert SensorMessage.build({"opcode": opcode, "params": data}) == encoded
...
def test_build_valid_setup(encoded, opcode, data):
    assert SensorSetupMessage.build({"opcode": opcode, "params": data}) == encoded
...
def test_build_valid_property(encoded, data):
    assert (
        SensorSetupMessage.build({"opcode": SensorSetupOpcode.SENSOR_SETTING_SET, "params": data}) == encoded
    )
            ...
            "params": [
                {
                    ...
                    "length": 2,
                    "format": 0,
                    "sensor_setting_raw": {"current": 2.0},
                }
            ],
        }
    )
