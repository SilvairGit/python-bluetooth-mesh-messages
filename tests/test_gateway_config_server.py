...
valid = [
    ...
    pytest.param(
        GatewayConfigParams,
        bytes.fromhex("01 B004 ABCDEFABCDEF D204 D007 19 7777772E72616E646F6D686F73746E616D652E636F6D2E706C"),
        GatewayConfigServerSubOpcode.GATEWAY_CONFIGURATION_SET,
        {
            "mtu_size": 1200,
            "mac_address": "ab:cd:ef:ab:cd:ef",
    ...
    pytest.param(
        GatewayConfigParams,
        bytes.fromhex("01 B004 ABCDEFABCDEF D204 D007 0B 3139322E3136382E302E31 0A2A0002"),
        GatewayConfigServerSubOpcode.GATEWAY_CONFIGURATION_SET,
        {
            "mtu_size": 1200,
            "mac_address": "ab:cd:ef:ab:cd:ef",
    ...
    pytest.param(
        GatewayConfigParams,
        bytes.fromhex(
            "01 DE03 ABCDEFABCDEF ABCD 04D219 7777772E72616E646F6D686F73746E616D652E636F6D2E706C 0A2A0002"
        ),
        GatewayConfigServerSubOpcode.GATEWAY_CONFIGURATION_SET,
        {
            "mtu_size": 990,
    ...
    pytest.param(
        ...
        {"gateway_ip_address": IPv4Address("192.168.12.3")},
    ...
    pytest.param(
        GatewayConfigParams,
        bytes.fromhex(
            "0C 0A B202 DDDDEFABCDEF 1111 2222 0F 7777772E74657374696E672E636F6D "
            "7B2C0515 C0A80A02 C0A80A01 0A 00 00"
        ),
    ...
    pytest.param(
        GatewayConfigParams,
        bytes.fromhex("0C 0A B202 DDDDEFABCDEF 1111 2222 00 C0A80A02 C0A80A02 C0A80A01 0A 02 00"),
        GatewayConfigServerSubOpcode.GATEWAY_CONFIGURATION_STATUS,
        {
            "chip_revision_id": 10,
            "mtu_size": 690,
